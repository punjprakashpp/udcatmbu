<%@ Page Title="Upload Notice" Language="C#" MasterPageFile="Admin.master" AutoEventWireup="true" CodeFile="UploadNotice.aspx.cs" Inherits="Admin_pages_UploadNotice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container">
        ...
        <asp:Label ID="lblLinkNo" runat="server" Text="Notice No.:"></asp:Label>
        ...
        <br />
        <asp:Label ID="lblFileUpload" runat="server" Text="Upload Notice PDF:"></asp:Label>
