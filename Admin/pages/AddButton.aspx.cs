...
public partial class Admin_pages_UploadMarqueeLinks : System.Web.UI.Page
{
    ...
    private void PopulateDropDownList()
    {
        ...
        string[] filePaths = Directory.GetFiles(Server.MapPath("~/pages/"), "*.aspx", SearchOption.AllDirectories);
        ddlLinkPicker.Items.Add(new ListItem("--Select Link--", string.Empty));
        // Add more predefined links as needed
        ddlLinkPicker.Items.Add(new ListItem("Google", "https://www.google.com/"));
        ddlLinkPicker.Items.Add(new ListItem("Facebook", "https://www.facebook.com/"));
        ddlLinkPicker.Items.Add(new ListItem("Instagram", "https://www.instagram.com/"));

        foreach (string filePath in filePaths)
        {
            string relativePath = filePath.Replace(Server.MapPath("~/pages/"), "pages/").Replace("\\", "/");
    ...
    {
        Response.Redirect("EditDeleteButton.aspx");
    }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(linkText) && !string.IsNullOrEmpty(linkURL))
        {
            ...
            {
                string query = "INSERT INTO Button (LinkText, LinkURL) VALUES (@LinkText, @LinkURL)";
