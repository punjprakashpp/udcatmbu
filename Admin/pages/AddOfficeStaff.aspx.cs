...
public partial class Admin_pages_AddFaculty : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("EditDeleteOfficeStaff.aspx");
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        string connStr = ConfigurationManager.ConnectionStrings["WebsiteConnectionString"].ConnectionString;
            ...
            {
                string query = "INSERT INTO Office (Name, Qualification, Position, Phone, Email, ImagePath) VALUES (@Name, @Qualification, @Position, @Phone, @Email, @ImagePath)";
