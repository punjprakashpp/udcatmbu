<%@ Page Title="" Language="C#" MasterPageFile="../Site.master" AutoEventWireup="true" CodeFile="EditDeleteAffReg.aspx.cs" Inherits="Admin_pages_EditDeleteAffReg" %>
    ...
    <div class="container">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AffRegID" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting" OnRowCancelingEdit="GridView1_RowCancelingEdit">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Affiliations/Regulations Date">
                    <EditItemTemplate>
