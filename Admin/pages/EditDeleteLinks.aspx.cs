    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow && (e.Row.RowState & DataControlRowState.Edit) > 0)
        {
            ...
            if (ddlLinkPicker != null)
            {
                ...
                ddlLinkPicker.Items.Insert(1, new ListItem("Google", "https://www.google.com/"));
                ddlLinkPicker.Items.Insert(2, new ListItem("Facebook", "https://www.facebook.com/"));
                ddlLinkPicker.Items.Insert(3, new ListItem("Instagram", "https://www.instagram.com/"));
