...
<asp:Content ID="ContentBody" ContentPlaceHolderID="Content" runat="Server">
    <div class="cont">
        <div class="container">
            ...
            <br />
            <p>&nbsp;&nbsp;&nbsp;&nbsp;T.M. Bhagalpur University offers segregated hostel accommodations for both male and female students. Availability of seats is limited, with allocations made based on university regulations. The hostel charges amount to ₹3800 annually for a double bedroom. These accommodations serve as a conducive living environment for students, fostering a sense of community and providing essential amenities. With a focus on student welfare, the university ensures fair allocation procedures and maintains reasonable pricing, facilitating an enriching academic experience for residents.</p>
            <div class="note">
                <h3>Note:</h3>
                <ol>
