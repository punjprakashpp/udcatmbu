    ...
    <div class="container">
        <div class="row">
            <div class="col col-md-5 m-auto">
                <h2 class="text-center">Upload Event Image/PDF</h2>
                <table class="table table-responsive">
                    <tr>
                        <td>Document Date: </td>
                        <td>
                            <asp:TextBox ID="txtNoticeDate" ToolTip="Event Date" CssClass="form-control flatpickr-input" runat="server" /></td>
                        </tr>
                    <tr>
                        <td>Document Title: </td>
                        <td>
                            <asp:TextBox ID="txtNoticeText" ToolTip="Event Text" CssClass="form-control" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>Select Document Image/PDF: </td>
                        <td>
                            <asp:FileUpload ID="fileUpload" ToolTip="Event File" CssClass="form-control" runat="server" /></td>
                    </tr>
                    <tr>
                        <td colspan="2">
