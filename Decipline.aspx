...
<asp:Content ID="ContentBody" ContentPlaceHolderID="Content" runat="Server">
    <div class="content">
        <div class="container">
            <h1>Student Discipline Rules</h1>
            <br />
            <p>Students enrolled in the University must recognize their responsibilities towards the faculty, office staff, and fellow students. Failure to maintain appropriate standards of conduct will attract disciplinary action.</p>
            <br />
            <p>The University believes that duty, decorum, and discipline are the hallmarks of a good student. The following acts would be deemed to be acts of indiscipline:</p>
            <br />
            <ul>
            ...
            <br />
            <p>Ragging in any form is strictly prohibited. If any incident of ragging comes to notice, the authority would expel the student from the University.</p>
            <br />
            <h2>Specific Rules for Student Discipline</h2>
            <br />
            ...
            <h2 align="center">Library Rules</h2>
            <br />
            <ol style="line-height: 1.6; margin-left: 10px; margin-bottom: 10px; padding-left: 20px;">
