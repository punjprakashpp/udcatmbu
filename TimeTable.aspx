    ...
    <section class="py-4 bg-light">
        <div style="max-width:1024px" class="container bg-white rounded shadow-sm p-4">
            ...
            <h1 class="text-center text-primary mb-4">
                Time Table:
                <a class="dnld" href="Uploads/docs/TimeTable.pdf" download="TimeTable.pdf">Download PDF</a>
            </h1>

            <!-- PDF Viewer -->
            <iframe src="/pdfjs/web/viewer.html?file=/Uploads/docs/TimeTable.pdf" allowfullscreen webkitallowfullscreen></iframe>
        </div>
    </section>
</asp:Content>
