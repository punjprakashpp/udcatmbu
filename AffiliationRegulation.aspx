...
<asp:Content ID="ContentBody" ContentPlaceHolderID="Content" runat="Server">
    <section class="py-5 bg-light">
        <div class="container contain bg-white rounded shadow-sm py-5 px-4">
            <h1 class="text-center text-white bg-gradient-primary rounded-top p-4 mb-4">Affiliations & Regulations</h1>

            <!-- Search and Controls Section -->
            <div class="row mb-4">
                <div class="col-md-4 text-start">
                    <label for="txtSearch" class="form-label">Search Affiliations & Regulations:</label>
