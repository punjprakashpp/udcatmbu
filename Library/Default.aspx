...
<body onscroll="onScroll()">
    ...
    <nav class="navbar" id="navbar">
        ...
        <div class="sidebar" id="sidebar">
            <img class="logo-nav" src="../img/logo/logo-head.png" alt="logo-head"/>
            <a href="javascript:void(0);" class="icon cut" id="close" onclick="toggleResponsive()"><i class="fa fa-close"></i></a>
            <div class="subnav">
        ...
        <div class="bg">
            ...
            <div id="main">
                ...
                <div id="login">
                    <table class="tbl">
                        <tr>
                            <td class="tblhead" colspan="2">Login to Automated Library
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">&nbsp;
    ...
    <footer class="footer-distributed">
        <div class="footer-left">
            ...
            <p style="font-size: 14px; line-height: 1.8em; padding-left: 10px;">
                <b>Location:</b> <a href="https://maps.app.goo.gl/Zv7E8aFZ3hYQ1ZMf6" target="_blank">Computer Center,</a> TMBU,<br />
                Bhagalpur, Bihar, 812007<br />
                <b>Phone:</b> <a href="tel:0641250040">0641-250040</a><br />
                ...
                <a href="../HowToReach.aspx">Click here to know How to Reach</a><br>
            </p>
        </div>
        ...
        <div class="footer-copyright">
            <p>
                ...
                UDCA TMBU | All Rights Reserved ! | Developed & Managed by UDCA TMBU | Visitor Count :
