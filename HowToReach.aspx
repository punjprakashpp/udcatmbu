<%@ Page Title="" Language="C#" MasterPageFile="Root.master" AutoEventWireup="true" CodeFile="HowToReach.aspx.cs" Inherits="About_Reach" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="cont" align="center">
        ...
        <br />
        <div>
            <h1 class="title">How to reach UDCA?</h1>
            <h2>1) From Bhagalpur Railway Station(junction):</h2>
            <br />
            <h3>ROUTE 1:</h3>
            <img src="img/reach/route 1.jpg" alt="tmbu" class="image"><br />
            <p>Bhagalpur Railway Station is the nearest railway station to the University Department of Computer Applications (UDCA). The UDCA is 2.2 km from Bhagalpur Railway Station (junction) and can be reached by auto rickshaw, easy cabs, or cycle rickshaw. Get down at Hindustan Press and travel another 550 meters by foot to reach the UDCA. Landmarks between Hindustan Press and UDCA include the M.Com Department, MBA Department, Rural Economics Department, Dinkar Bhawan, and Multi-Purpose Hall (just 50 meters back). The destination will be on your right.</p>
            <br />
            <h3>ROUTE 2:</h3>
